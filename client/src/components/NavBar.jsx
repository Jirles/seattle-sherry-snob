...
export const NavBar = () => {
    return (
        <div className='clearfix border-bottom' >
            <div className='left p1' ><Link to='/' className='h1 caps text-decoration-none' >Seattle Sherry Snob<img alt='Pouring a glass of sherry' src='http://localhost:3001/api/banner-image' width='25%'/></Link></div>
